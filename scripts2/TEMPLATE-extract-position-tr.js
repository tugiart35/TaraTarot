...
const POSITION_NUMBER = 2;            // 1, 2, 3, 4, vb.
const FILE_NAME = 'position-2-fiziksel.ts';  // position dosyasının adı
const ARRAY_NAME = `position${POSITION_NUMBER}Meanings`;  // position2Meanings, vb.
const TYPE_NAME = `LovePositionMeaning`;  // LovePosition1Meaning, vb.
