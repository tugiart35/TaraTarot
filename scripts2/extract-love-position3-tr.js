...
const SPREAD_NAME = 'love';           // 'love', 'career', 'money', vb.
const POSITION_NUMBER = 3;            // 1, 2, 3, 4, vb.
const FILE_NAME = 'position-3-baglanti.ts';  // position dosyasının adı
const ARRAY_NAME = `position${POSITION_NUMBER}Meanings`;  // position3Meanings, vb.
const TYPE_NAME = `LovePositionMeaning`;  // LovePositionMeaning, vb.
