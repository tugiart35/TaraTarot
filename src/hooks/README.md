...
Bu dosya, `src/hooks/` klasöründeki tüm React hook'larının işlevlerini, kullanım
alanlarını ve bağımlılıklarını açıklar.
...
_Bu dokümantasyon, hooks klasöründeki tüm dosyaların detaylı analizi sonucu
hazırlanmıştır. Güncel tutulması için düzenli olarak güncellenmelidir._
