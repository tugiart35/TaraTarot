...
export const NUMBER_MEANINGS: Record<number, NumberMeaning> = {
  1: {
    ...
    description:
      '1 sayısı liderlik, bağımsızlık ve yeni başlangıçları temsil eder. Bu sayıya sahip kişiler doğal liderlerdir ve kendi yollarını çizerler.',
    positiveTraits: [
  ...
  2: {
    ...
    description:
      '2 sayısı işbirliği, denge ve uyumu temsil eder. Bu sayıya sahip kişiler doğal diplomatlardır ve uyum sağlama konusunda yeteneklidirler.',
    positiveTraits: [
    ...
    expressionMeaning:
      'İfade sayısı 2 olan kişiler uyum, işbirliği ve diplomasi enerjisini taşırlar. Onlar farklı tarafları bir araya getirme, anlaşmazlıkları çözme ve denge yaratma konusunda doğuştan yeteneklidir. Çevrelerinde yumuşak, nazik ve destekleyici bir varlık olarak öne çıkarlar.\n\nAncak aşırı uyum sağlama isteği bazen kendi ihtiyaçlarını bastırmalarına yol açabilir. Kendi sınırlarını belirlemeyi öğrendiklerinde, hem ilişkilerinde hem de topluluk içinde şifalandırıcı bir güç haline gelirler.',
    personalityMeaning:
      'Kişilik sayısı 2 olan kişiler dışarıdan nazik, uyumlu ve duyarlı görünürler. Onlar başkalarıyla kolay bağ kurar, şefkatli ve anlayışlı bir enerji yayarlar. Çevrelerinde genellikle sıcak, güven veren ve işbirliğine açık bir imaj sergilerler.\n\nAncak fazla uyum arayışı, başkaları tarafından pasif ya da kararsız olarak algılanmalarına sebep olabilir. Sınırlarını net belirlediklerinde, hem nazik hem de güçlü bir duruşa sahip olurlar.',
  },
  ...
  3: {
    ...
    description:
      '3 sayısı yaratıcılık, iletişim ve sosyalliği temsil eder. Bu sayıya sahip kişiler doğal sanatçılar ve iletişimcilerdir.',
    positiveTraits: [
  ...
  4: {
    ...
    description:
      '4 sayısı pratiklik, güvenilirlik ve stabiliteyi temsil eder. Bu sayıya sahip kişiler güvenilir ve çalışkandırlar.',
    positiveTraits: [
      'Güvenilir ve sadık',
      'Pratik ve gerçekçi',
      'Çalışkan ve azimli',
    ...
    lifeGuidance:
      'Pratik yaklaşımınızı koruyun ama esneklik de gösterin. Yeni deneyimlere açık olun.',
    careerAdvice:
      'Mühendislik, finans, yönetim, inşaat ve güvenilirlik gerektiren alanlar sizin için idealdir.',
    relationshipAdvice:
      'Partnerinize güven verin ve birlikte istikrarlı bir gelecek kurun.',
    spiritualMessage:
      'Ruhsal yolculuğunuzda pratik yaklaşımınızı koruyun ve sabırlı olun.',
    color: 'Yeşil',
    element: 'Toprak',
    planet: 'Uranüs',
    birthdayMeaning:
      'Doğum günü sayısı 4 olanlar düzen, disiplin ve yapı getiren kişilerdir. Onlar güvenilir, çalışkan ve sorumluluk sahibi bireylerdir. Zorluklarla karşılaştıklarında sabırla ve planlı bir şekilde ilerlerler. Hayatlarına sağlam bir temel kurmak, hem kendileri hem de sevdikleri için istikrar yaratmak isterler.\n\nZaman zaman katı, inatçı ya da fazla kontrolcü olabilirler. Bu durum ilişkilerde esnekliği zorlaştırabilir. Esneklik geliştirdiklerinde, hem kendi hayatlarında hem de çevrelerinde sağlam bir yapı kurarak kalıcı başarılar elde ederler.',
    lifePathMeaning:
    ...
    expressionMeaning:
      'İfade sayısı 4 olan kişiler düzen, istikrar ve çalışkanlık enerjisiyle bilinirler. Onlar sağlam temeller atar, sorumluluklarını yerine getirir ve uzun vadeli projelerde kalıcı başarı sağlarlar. Çevreleri onları güvenilir ve disiplinli kişiler olarak görür.\n\nAncak fazla katı ya da inatçı olmak, değişime direnç göstermek gölge yönleri olabilir. Esneklik kazandıklarında, güçlü yapılandırıcı enerjileriyle hem kendilerine hem de başkalarına kalıcı değer katarlar.',
  },
  ...
  5: {
    ...
    description:
      '5 sayısı özgürlük, macera ve değişimi temsil eder. Bu sayıya sahip kişiler özgür ruhlu ve maceracıdırlar.',
    positiveTraits: [
    ...
    lifeGuidance:
      'Özgürlüğünüzü koruyun ama sorumluluklarınızı da unutmayın. Dengeli bir yaşam sürün.',
    careerAdvice:
      'Seyahat, satış, iletişim, eğlence ve değişken alanlar sizin için idealdir.',
    relationshipAdvice:
      'Partnerinize özgürlük tanıyın ve birlikte maceralar yaşayın.',
    spiritualMessage:
      'Ruhsal yolculuğunuzda özgürlük arayın ve yeni deneyimlere açık olun.',
    color: 'Mavi',
    element: 'Hava',
    planet: 'Merkür',
    birthdayMeaning:
      'Doğum günü sayısı 5 olanlar özgürlüğün, maceranın ve değişimin temsilcileridir. Onlar sürekli yeni deneyimler arar, farklı kültürler ve insanlar tanımaktan beslenirler. Hızlı öğrenirler ve hayatın getirdiği değişimlere kolayca uyum sağlarlar. Çevrelerinde heyecan, yenilik ve canlılık katarlar.\n\nAncak bu özgürlük ihtiyacı bazen sabırsızlığa, düzensizliğe veya bağlanma korkusuna dönüşebilir. Kendilerini sınırlamak istemezler. Fakat sorumlulukla özgürlüğü dengelemeyi öğrendiklerinde, hayatları ilham verici bir keşif yolculuğuna dönüşür.',
    lifePathMeaning:
      'Yaşam Yolu 5 olan kişiler özgürlük, macera ve değişimin temsilcileridir. Onlar sürekli keşif arayışıyla hayatın içinde hareket ederler. Yeni kültürler, deneyimler ve insanlar tanımak onların ruhunu besler. Değişime kolay uyum sağladıkları için yenilikçi fikirlerin hayata geçmesinde öncü olabilirler.\n\nAncak sabırsızlık, kararsızlık ve istikrarsızlık gölge yönleridir. Özgürlüğü sorumlulukla dengelemeyi öğrendiklerinde, yaşamları hem kendileri hem de çevreleri için heyecan verici bir yolculuğa dönüşür.',
    expressionMeaning:
      'İfade sayısı 5 olan kişiler özgürlük, macera ve değişimin temsilcileridir. Onlar yeni deneyimlere, farklı kültürlere ve keşiflere büyük bir istekle yönelirler. Hızlı öğrenir, farklı alanlarda uyum sağlar ve çevrelerine canlılık katarlar.\n\nFakat sabırsızlık veya düzensizlik onları zayıf bir zemine çekebilir. Sorumluluk bilinciyle özgürlük arzusunu dengelediklerinde, yaşamları hem kendileri hem de başkaları için ilham verici bir yolculuğa dönüşür.',
  },
  ...
  6: {
    ...
    description:
      '6 sayısı şefkat, koruma ve sorumluluğu temsil eder. Bu sayıya sahip kişiler doğal koruyuculardır.',
    positiveTraits: [
    ...
    lifeGuidance:
      'Başkalarını korurken kendinizi de ihmal etmeyin. Denge kurun.',
    careerAdvice:
      'Eğitim, sağlık, sanat, aile danışmanlığı ve koruma gerektiren alanlar sizin için idealdir.',
    relationshipAdvice:
      'Partnerinizi koruyun ama onun özgürlüğüne de saygı gösterin.',
    spiritualMessage:
      'Ruhsal yolculuğunuzda şefkat ve koruma enerjisini kullanın.',
    color: 'İndigo',
    element: 'Toprak',
    planet: 'Venüs',
    birthdayMeaning:
      'Doğum günü 6 olan kişiler sevgi, uyum ve sorumluluk enerjisi taşır. Onlar ailelerine, dostlarına ve topluma karşı derin bir bağlılık hissederler. Yardımseverlikleri, estetik anlayışları ve güzellik yaratma istekleri onları başkaları için güvenilir bir sığınak haline getirir.\n\nBazen aşırı fedakârlık, kendi ihtiyaçlarını ihmal etme ya da başkalarının sorunlarını üstlenme eğilimleri olabilir. Kendi sınırlarını korumayı öğrendiklerinde, hem kendileri hem de çevreleri için şifalandırıcı bir güç haline gelirler.',
    lifePathMeaning:
      'Yaşam Yolu 6 olan kişiler sorumluluk, aile ve sevgi enerjisiyle hayata gelirler. Onlar başkalarına yardım etme, uyum sağlama ve güzellik yaratma konusunda güçlü bir isteğe sahiptir. Çevrelerinde koruyucu, destekleyici ve güvenilir bir enerji olarak tanınırlar. Estetik anlayışları ve uyum yaratma yetenekleri güçlüdür.\n\nAncak fazla fedakârlık yapma veya başkalarının sorunlarını üstlenme eğilimleri olabilir. Kendi ihtiyaçlarını da gözetmeyi öğrendiklerinde, hem kendileri hem de başkaları için şifalandırıcı bir güç haline gelirler.',
    expressionMeaning:
      'İfade sayısı 6 olan kişiler sevgi, uyum ve sorumluluk enerjisi taşır. Onlar ailelerine, topluma ve çevresine karşı güçlü bir bağlılık hissederler. Yardımseverlikleri, estetik anlayışları ve güzellik yaratma arzuları sayesinde çevrelerinde güvenilir bir figür haline gelirler.\n\nAncak fazla fedakârlık ya da başkalarının sorunlarını üstlenme eğilimleri olabilir. Kendi sınırlarını koruduklarında, hem sevdiklerini hem de toplumu iyileştiren bir güç olurlar.',
  },
  ...
  7: {
    ...
    description:
      '7 sayısı bilgelik, ruhsallık ve içe dönüklüğü temsil eder. Bu sayıya sahip kişiler doğal filozoflardır.',
    positiveTraits: [
    ...
    lifeGuidance:
      'İç dünyanızı keşfedin ama dış dünyayla da bağlantı kurun. Denge sağlayın.',
    careerAdvice:
      'Araştırma, felsefe, ruhsallık, terapi ve analiz gerektiren alanlar sizin için idealdir.',
    relationshipAdvice:
      'Partnerinizle derinlemesine bağlantı kurun ve ruhsal yolculuğunuzu paylaşın.',
    spiritualMessage:
      'Ruhsal yolculuğunuzda bilgelik arayın ve iç dünyanızı keşfedin.',
    color: 'Mor',
    element: 'Su',
    planet: 'Neptün',
    birthdayMeaning:
      'Doğum günü 7 olanlar araştırmacı, derin düşünen ve sezgisel kişilerdir. Onlar hayatı sorgulayan, gerçeğin ardındaki gizemi arayan bir ruha sahiptir. Bilim, felsefe, mistisizm veya spiritüel konulara ilgi duyarlar. İçsel dünyaları güçlüdür ve yalnızlık onlar için besleyici olabilir.\n\nAncak aşırı içe kapanma, soğukluk ya da mesafe koyma eğilimleri olabilir. Başkalarıyla duygusal bağ kurmayı öğrendiklerinde, bilgeliğiyle başkalarına ışık tutan bir öğretmen haline gelirler.',
    lifePathMeaning:
      'Yaşam Yolu 7 olan kişiler içe dönüş, araştırma ve ruhsallıkla beslenirler. Onlar hayatın derin anlamlarını arar, görünmeyeni sorgular ve sezgileriyle rehberlik ederler. Bilim, felsefe, spiritüel alanlar veya sanatın derinlikleri onlara çekici gelir. Sessizlik ve yalnızlık, onların içsel bilgeliklerini besleyen bir alandır.\n\nAncak fazla içe kapanma veya soğuk görünme eğilimi olabilir. Başkalarıyla dengeli bağlar kurduklarında, bilgeliğiyle çevresine ışık tutan bir rehber olurlar.',
    expressionMeaning:
      'İfade sayısı 7 olan kişiler bilgi, araştırma ve ruhsal derinlik enerjisine sahiptir. Onlar hayatın anlamını sorgular, görünmeyen gerçekleri arar ve sezgileriyle rehberlik eder. Çoğu zaman bilim, felsefe veya spiritüel alanlara çekilirler.\n\nAncak fazla içe kapanma ya da mesafeli duruş ilişkilerde zorluk yaratabilir. İçsel bilgeliklerini başkalarıyla paylaşmayı öğrendiklerinde, çevrelerine ışık tutan değerli bir rehber haline gelirler.',
  },
  ...
  8: {
    ...
    description:
      '8 sayısı liderlik, organizasyon ve maddi başarıyı temsil eder. Bu sayıya sahip kişiler doğal liderlerdir.',
    positiveTraits: [
      'Güçlü liderlik yetenekleri',
  ...
  9: {
    ...
    description:
      '9 sayısı evrensellik, cömertlik ve spiritüaliteyi temsil eder. Bu sayıya sahip kişiler evrensel düşünürlerdir.',
    positiveTraits: [
      'Evrensel düşünce',
    ...
    lifeGuidance:
      'Evrensel hizmetinizi sürdürün ama kendi ihtiyaçlarınızı da göz ardı etmeyin.',
    careerAdvice:
      'Sanat, eğitim, ruhsallık, hümaniter çalışmalar ve evrensel hizmet alanları sizin için idealdir.',
    relationshipAdvice:
      'Partnerinizle evrensel bir bağ kurun ve birlikte büyük hayaller gerçekleştirin.',
    spiritualMessage:
      'Ruhsal yolculuğunuzda evrensel hizmet ve tamamlanma arayın.',
    color: 'Altın',
    element: 'Ateş',
    planet: 'Mars',
    birthdayMeaning:
      'Doğum günü 9 olanlar şefkatli, idealist ve sanatsal ruhlu kişilerdir. Onlar insanlığa hizmet etmeyi, iyiliği ve güzelliği paylaşmayı yaşamlarının merkezine koyarlar. Yaratıcı yönleriyle toplumda fark yaratabilir, başkalarının hayatına dokunabilirler.\n\nBazen fazla duygusal, hayalci ya da fedakâr olabilirler. Ancak kendi sınırlarını ve gerçeklerini gözeterek yaşadıklarında, dünyada kalıcı bir iz bırakan insancıl liderler haline gelirler.',
    lifePathMeaning:
      'Yaşam Yolu 9 olan kişiler şefkat, idealizm ve insanlık sevgisiyle hareket ederler. Onlar dünyayı daha iyi bir yer yapmak ister, fedakârlıkla topluma katkı sağlarlar. Sanatsal yönleri güçlü olabilir ve başkalarının hayatına dokunan projeler yaratabilirler.\n\nAncak fazla duygusal, hayalci veya aşırı fedakâr olma eğilimleri vardır. Kendi sınırlarını koruduklarında ve gerçekçilikle idealizmi birleştirdiklerinde, dünyada kalıcı iz bırakan insancıl liderler haline gelirler.',
    expressionMeaning:
      'İfade sayısı 9 olan kişiler idealizm, şefkat ve insanlık sevgisiyle hareket ederler. Onlar insanlığa hizmet etmeyi, başkalarının hayatına dokunmayı ve sanatsal projelerle topluma katkı sağlamayı önemserler. Çevrelerinde yardımsever ve vizyoner olarak tanınırlar.\n\nAncak aşırı fedakârlık veya hayalcilik onları yıpratabilir. Gerçekçiliği koruyarak şefkatlerini sunmayı öğrendiklerinde, dünyada kalıcı iz bırakan insancıl liderler olurlar.',
  },
  ...
  11: {
    ...
    description:
      '11 sayısı ruhsallık, sezgisel yetenekler ve öğretmenliği temsil eder. Bu master sayıya sahip kişiler ruhsal öğretmenlerdir.',
    positiveTraits: [
    ...
    lifeGuidance:
      'Ruhsal öğretmenliğinizi kullanın ama dünyevi sorumluluklarınızı da unutmayın.',
    careerAdvice:
      'Ruhsallık, öğretmenlik, terapi, sanat ve ilham verici alanlar sizin için idealdir.',
    relationshipAdvice:
      'Partnerinizle ruhsal bir bağ kurun ve birlikte büyüyün.',
    spiritualMessage:
      'Ruhsal yolculuğunuzda öğretmenlik yapın ve başkalarına ilham verin.',
    color: 'Gümüş',
    element: 'Hava',
    planet: 'Uranüs',
    birthdayMeaning:
      'Doğum günü sayısı 11 olanlar sezgisel, vizyoner ve ruhsal açıdan güçlü kişilerdir. Onların enerjisi yüksek frekansta çalışır ve çevrelerine ilham verir. Doğuştan gelen bir farkındalıkla, hayatlarında ilahi rehberliği hissetmeleri mümkündür.\n\nAncak bu yoğun enerji onları huzursuz, kaygılı veya dengesiz kılabilir. Kendilerini toprakladıklarında, çevrelerine ilham veren ve rehberlik eden bir ışık haline gelirler.',
    lifePathMeaning:
      'Yaşam Yolu 11 olan kişiler yüksek sezgi, vizyon ve ilham enerjisi taşırlar. Onlar doğuştan spiritüel bir farkındalığa sahiptir ve çevrelerine ilham verme konusunda güçlüdür. Vizyonlarıyla insanlara yol gösterebilir ve ilahi rehberlikleriyle kolektife katkı sağlayabilirler.\n\nAncak bu yoğun enerji kaygı, huzursuzluk veya dengesizlik yaratabilir. Kendilerini dengelediklerinde, hem ışık saçan bir rehber hem de çevresine şifa getiren bir vizyoner haline gelirler.',
    expressionMeaning:
      'İfade sayısı 11 olan kişiler vizyoner, sezgisel ve ilham verici bir enerji taşırlar. Onlar yüksek frekanslı bir bilince sahiptir ve çevrelerine ışık tutma konusunda güçlüdürler. Çoğu zaman sanat, spiritüel alanlar veya toplumsal rehberlikte öne çıkarlar.\n\nAncak yoğun enerjileri kaygı, huzursuzluk ya da dengesizlik yaratabilir. Kendilerini dengelediklerinde, çevrelerine ilham ve rehberlik sunan bir ışık haline gelirler.',
  },
  ...
  22: {
    ...
    description:
      '22 sayısı büyük hayalleri gerçeğe dönüştürme yeteneğini temsil eder. Bu master sayıya sahip kişiler usta inşaatçılardır.',
    positiveTraits: [
    ...
    lifeGuidance:
      'Büyük hayallerinizi gerçekleştirin ama dengeli bir yaşam sürün.',
    careerAdvice:
      'İnşaat, organizasyon, liderlik, büyük projeler ve evrensel hizmet alanları sizin için idealdir.',
    relationshipAdvice:
      'Partnerinizle büyük hayaller kurun ve birlikte başarıya odaklanın.',
    spiritualMessage:
      'Ruhsal yolculuğunuzda büyük hayallerinizi gerçekleştirin.',
    color: 'Platin',
    element: 'Toprak',
    planet: 'Satürn',
    birthdayMeaning:
      'Doğum günü 22 olanlar büyük vizyonların kurucusudur. Onlar güçlü hayalleri gerçeğe dönüştürme yeteneğine sahiptir. Disiplinli, pratik ve kararlı yapıları sayesinde hem maddi hem de manevi dünyada büyük başarılar elde edebilirler.\n\nFakat bu büyük enerji sorumluluk baskısı yaratabilir. Küçük hedeflerle yetinmediklerinde, büyük projeler inşa ederek dünyada kalıcı izler bırakırlar.',
    lifePathMeaning:
      'Yaşam Yolu 22 olan kişiler usta kurucular olarak bilinir. Onlar büyük hayalleri gerçeğe dönüştürme gücüne sahiptir. Pratik, disiplinli ve vizyoner yapıları sayesinde dünyada kalıcı projeler inşa edebilirler. Hem maddi hem manevi başarıyı aynı anda yaratma potansiyeline sahiptirler.\n\nAncak bu büyük enerji bazen ağır sorumluluk baskısı yaratabilir. Küçük hedeflerle yetinmediklerinde, dünyada kalıcı bir miras bırakma potansiyellerini açığa çıkarırlar.',
    expressionMeaning:
      'İfade sayısı 22 olan kişiler usta kurucular olarak bilinir. Onlar büyük hayalleri somut başarıya dönüştürme yeteneğine sahiptir. Disiplinli, vizyoner ve pratik yapıları sayesinde toplumda büyük projelere imza atabilirler.\n\nAncak bu büyük enerji sorumluluk baskısı yaratabilir. Küçük hedeflerle yetinmeyip vizyonlarını gerçekleştirdiklerinde, dünyada kalıcı miraslar bırakırlar.',
  },
  ...
  33: {
    ...
    description:
      '33 sayısı en yüksek seviyede öğretmenlik ve evrensel hizmeti temsil eder. Bu master sayıya sahip kişiler usta öğretmenlerdir.',
    positiveTraits: [
    ...
    lifeGuidance:
      'Evrensel hizmetinizi sürdürün ama kendi ihtiyaçlarınızı da göz ardı etmeyin.',
    careerAdvice:
      'Öğretmenlik, ruhsallık, hümaniter çalışmalar, terapi ve evrensel hizmet alanları sizin için idealdir.',
    relationshipAdvice:
      'Partnerinizle evrensel bir bağ kurun ve birlikte hizmet edin.',
    spiritualMessage:
      'Ruhsal yolculuğunuzda en yüksek seviyede öğretmenlik yapın.',
    color: 'Kristal',
    element: 'Su',
    planet: 'Neptün',
    birthdayMeaning:
      'Doğum günü 33 olanlar koşulsuz sevgi, şefkat ve şifa enerjisinin taşıyıcılarıdır. Onlar başkalarının iyiliği için yaşayan, derin bir sorumluluk ve fedakârlık duygusu hisseden kişilerdir. İnsanlara ilham verir, kalpleri yumuşatır ve topluluklara rehberlik ederler.\n\nAncak bu yüksek enerji yükümlülük baskısı yaratabilir. Kendilerini tükenmeden ifade etmeyi öğrendiklerinde, dünyada kalıcı bir şifa izi bırakırlar ve kolektifin iyileşmesine katkı sağlarlar.',
    lifePathMeaning:
      'Yaşam Yolu 33 olan kişiler koşulsuz sevgi, şefkat ve hizmet enerjisini taşır. Onlar başkalarının iyileşmesine aracılık eden, topluma rehberlik eden bir ruhla dünyaya gelirler. Öğretici yönleri, şefkatli tavırları ve yüksek enerjileriyle çevrelerine ışık tutarlar.\n\nAncak bu yoğun enerji bazen aşırı fedakârlık ya da tükenmişlik riski yaratabilir. Kendi sınırlarını koruduklarında ve sevgilerini dengeli şekilde ifade ettiklerinde, dünyada şifa ve rehberlik sunan güçlü bir figür olurlar.',
    expressionMeaning:
      'İfade sayısı 33 olan kişiler koşulsuz sevgi, şefkat ve şifa enerjisini taşır. Onlar başkalarının iyiliği için yaşayan, öğretici ve rehber kişilerdir. Çevrelerine ilham veren, şifalandıran ve rehberlik eden bir ışık olurlar.\n\nAncak bu yoğun enerji tükenmişlik ya da aşırı sorumluluk duygusuna dönüşebilir. Dengeli kaldıklarında, topluma kalıcı sevgi ve şifa getiren güçlü bir rehber haline gelirler.',
  },
};
