...
export default function HeadTags() {
  return (
    <>
      ...
      <meta
        name='description'
        content='Tarot okumaları, numeroloji hesaplamaları ve kişisel gelişim rehberliği. Uzman falcılar ile online tarot kartları ve numeroloji analizi.'
      />
      <meta
        name='keywords'
        content='tarot, numeroloji, fal, kart okuma, kişisel gelişim, online tarot, tarot kartları, numeroloji hesaplama'
      />
      ...
      <meta
        property='og:title'
        content='Busbuskimki Tarot - Online Tarot ve Numeroloji'
      />
      <meta
        property='og:description'
        content='Profesyonel tarot okumaları ve numeroloji hesaplamaları. Uzman falcılar ile kişisel rehberlik.'
      />
      <meta property='og:type' content='website' />
      <meta property='og:url' content='https://busbuskimki.com' />
      <meta
        property='og:image'
        content='https://busbuskimki.com/images/og-image.jpg'
      />
      ...
      <meta
        name='twitter:image'
        content='https://busbuskimki.com/images/twitter-card.jpg'
      />
      ...
      <meta
        ...
        content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://www.google-analytics.com https://www.googletagmanager.com https://vitals.vercel-insights.com; frame-ancestors 'none';"
      />
