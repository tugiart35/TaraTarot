...
export const position6Meanings: RelationshipAnalysisPositionMeaning[] = [
  // MAJÖR ARKANA
    {
      ...
      context: 'Partnerin, hem hafiflik hem de güven veren yeni bir başlangıç istiyor.',
      group: 'Majör Arkana',
    },
    {
    ...
    },
    {
      ...
      context: 'Partnerin, senin sezgine yaslanmak ama aynı zamanda açıklık görmek istiyor.',
      group: 'Majör Arkana',
    },
    {
    ...
    },
    {
      ...
      context: 'Partnerin, ortak değerler ve özgün ritüellerle bağ kurmak istiyor.',
      group: 'Majör Arkana',
    },
    {
    ...
    },
    {
      ...
      keywords: ['tamamlanma', 'bütünlük', 'kutlama', 'yeni aşama', 'entegrasyon'],
  ...
  // CUPS (Kupalar)
    ...
    },
    {
      ...
      context: 'Partnerin, geçmişi onurlandırmanı ama şimdiye odaklanmanı bekliyor.',
      group: 'Kupalar',
    },
    {
  ...
  // SWORDS (Kılıçlar)
    ...
    },
    {
      ...
      context: 'Partnerin, acını dürüstçe paylaşmanı ve affedişi seçmeni bekliyor.',
      group: 'Kılıçlar',
    },
    {
    ...
    },
    {
      ...
      context: 'Partnerin, geçmişi geride bırakıp birlikte ileriye bakmanı bekliyor.',
      group: 'Kılıçlar',
    },
    {
    ...
    },
    {
      ...
      context: 'Partnerin, kaygılarını paylaşmanı ama umutla dengelemeni bekliyor.',
      group: 'Kılıçlar',
    },
    {
...
export const getAllPosition6Meanings = (): RelationshipAnalysisPositionMeaning[] => {
