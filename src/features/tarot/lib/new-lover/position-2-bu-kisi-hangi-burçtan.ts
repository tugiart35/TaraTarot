...
export const getI18nposition2Meaning = (
  ...
  const cardKey = cardName
    ...
    .replace(/[^a-z0-9]/g, '');
  const i18nUpright = t(
    `new-lover.meanings.${cardKey}.position2.upright`
  );
  const i18nReversed = t(
    `new-lover.meanings.${cardKey}.position2.reversed`
  );
  const i18nKeywords = t(
    `new-lover.meanings.${cardKey}.position2.keywords`
  );
  const i18nContext = t(
    `new-lover.meanings.${cardKey}.position2.context`
  );
  const i18nGroup = t(
