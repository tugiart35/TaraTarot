...
export const position3Meanings: NewLoverposition3Meaning[] = [
  // --- Majör Arkana Kartları ---
    {
      ...
      context: 'Uyum için özgürlüğü paylaşmak gerekir. Fazla acele, dengeyi bozabilir.',
      group: 'Majör Arkana',
    },
    {
  ...
  // --- Asalar Serisi ---//
    ...
    },
    {
      ...
      context: 'Besleyici enerji uyumu büyütür. Öz bakım eksikliği bağı zayıflatır.',
      group: 'Tılsımlar',
    },
    {
    ...
    //--- Tılsımlar Serisi ---
      ...
      },
      {
        ...
        reversed:
          'Ters Değnek Yedilisi, fazla savunmacılık uyumu zedeleyebilir.',
      ...
      },
      {
        ...
        reversed:
          'Ters Değnek Sekizlisi, iletişimde aksaklıklar uyumu bozabilir.',
...
export const getI18nposition3Meaning = (
  ...
  const cardKey = cardName
    ...
    .replace(/[^a-z0-9]/g, '');
  const i18nUpright = t(
    `new-lover.meanings.${cardKey}.position3.upright`
  );
  const i18nReversed = t(
    `new-lover.meanings.${cardKey}.position3.reversed`
  );
  const i18nKeywords = t(
    `new-lover.meanings.${cardKey}.position3.keywords`
  );
  const i18nContext = t(
    `new-lover.meanings.${cardKey}.position3.context`
  );
  const i18nGroup = t(
