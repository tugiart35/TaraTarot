...
},
{
  ...
  context:
    'Sürmesi için: açık hedef, yazılı küçük plan ve düzenli check-in.',
  group: 'Majör Arkana',
},
{
...
},
{
  ...
  context:
    'Sürmesi için: birlikte yazılmış kurallar + esnek uygulama.',
  group: 'Majör Arkana',
},
{
  ...
  context:
    'Sürmesi için: ortak değer bildirgesi + gereksiz normları eleme.',
  group: 'Majör Arkana',
},
{
  ...
  context:
    'Sürmesi için: açık taahhüt + ortak rota + net sınırlar.',
  group: 'Majör Arkana',
},
{
  ...
  context:
    'Sürmesi için: tempo anlaşması + ivmeyi ortaklaştırma.',
  group: 'Majör Arkana',
},
{
  id: 'strength_rc_pos9',
  ...
  keywords: ['sabır', 'nazik güç', 'regülasyon', 'kıskançlık', 'dayanıklılık'],
  context:
    'Sürmesi için: tetik haritası + sakinleşme protokolü.',
  group: 'Majör Arkana',
},
{
  ...
  context:
    'Sürmesi için: planlı alan + planlı bağlantı ritmi.',
  group: 'Majör Arkana',
},
{
  ...
  context:
    'Sürmesi için: döngü farkındalığı + küçük sistem güncellemeleri.',
  group: 'Majör Arkana',
},
{
  id: 'justice_rc_pos9',
  ...
  context:
    'Sürmesi için: açık metrikler + hızlı onarım kültürü.',
  group: 'Majör Arkana',
},
{
  ...
  context:
    'Sürmesi için: süreli fedakârlık + net dönüş tarihi.',
  group: 'Majör Arkana',
},
{
  id: 'death_rc_pos9',
  ...
  context:
    'Sürmesi için: vedalaş–yenile; yer açmadan devam zor.',
  group: 'Majör Arkana',
},
{
  ...
  context:
    'Sürmesi için: ritim sözleşmesi + küçük düzenli ayar.',
  group: 'Majör Arkana',
},
{
...
},
{
  ...
  context:
    'Sürmesi için: çıplak gerçek + net onarım protokolü.',
  group: 'Majör Arkana',
},
{
  id: 'the_star_rc_pos9',
  ...
  context:
    'Sürmesi için: umut + ölçülebilir mini hedefler.',
  group: 'Majör Arkana',
},
{
  id: 'the_moon_rc_pos9',
  ...
  context:
    'Sürmesi için: doğrulama kültürü + açık dil.',
  group: 'Majör Arkana',
},
{
  id: 'the_sun_rc_pos9',
...
},
{
  ...
  context:
    'Sürmesi için: açık muhasebe + somut değişim.',
  group: 'Majör Arkana',
},
{
  ...
  context:
    'Sürmesi için: açık uçları kapatın, ortak vizyonu yazın.',
  group: 'Majör Arkana',
},
...
// CUPS (14)
{
  ...
  context:
    'Sürmesi için: duyguyu adlandırma + yumuşak ifade ritmi.',
  group: 'Kupalar',
},
{
  ...
  context:
    'Sürmesi için: haftalık minik jest ve teşekkür protokolü.',
  group: 'Kupalar',
},
{
  ...
  context:
    'Sürmesi için: güvenli çevre + mahremiyet sınırı.',
  group: 'Kupalar',
},
{
  ...
  reversed:
    'Ters Dört Kupa, ilgisizlik kronikleşirse ilişki sönümlenir.',
  keywords: ['apatik', 'fırsat', 'yenileme', 'ilgi', 'motivasyon'],
  context:
    'Sürmesi için: planlı yeni deneyimler + takdir rutini.',
  group: 'Kupalar',
},
{
  ...
  reversed:
    'Ters Beş Kupa, geçmişte takılı kalmak sürekliliği engeller.',
  keywords: ['yas', 'telafi', 'umut', 'geçmiş', 'onarma'],
  context:
    'Sürmesi için: kapanış konuşması + geleceğe odak.',
  group: 'Kupalar',
},
{
  ...
  reversed:
    'Ters Altı Kupa, nostalji bugünü gölgelerse ilerleme durur.',
  keywords: ['nostalji', 'anı', 'şefkat', 'ilerleme', 'denge'],
  context:
    'Sürmesi için: anı + bugünü besleyen ritüeller.',
  group: 'Kupalar',
},
{
  ...
  context:
    'Sürmesi için: beklenti listesi + tarih/kriter.',
  group: 'Kupalar',
},
{
  ...
  reversed:
    'Ters Sekiz Kupa, kal–git sarkacı uzun süre sürerse bağ gevşer.',
  keywords: ['bırakma', 'anlam', 'yön', 'ikilem', 'yenilenme'],
  context:
    'Sürmesi için: ortak yön kararı + net taahhüt.',
  group: 'Kupalar',
},
{
  ...
  context:
    'Sürmesi için: minnet ritüeli + ortak sevinç planı.',
  group: 'Kupalar',
},
{
  ...
  context:
    'Sürmesi için: gerçek ihtiyaçlara dayalı ev/ilişki vizyonu.',
  group: 'Kupalar',
},
{
  ...
  context:
    'Sürmesi için: açık duygu cümleleri + küçük jest ritmi.',
  group: 'Kupalar',
},
{
  ...
  context:
    'Sürmesi için: az ama düzenli jest + net söz.',
  group: 'Kupalar',
},
{
  ...
  position: 9,
  upright:
    'Kupa Kraliçesi, empatik alan ve güvenli bağ uzun ömrü destekler.',
  reversed:
  ...
  context:
    'Sürmesi için: şefkat + sınırın birlikte kurulması.',
  group: 'Kupalar',
},
{
  ...
  context:
    'Sürmesi için: duyguyu isimlendir + zor konuşmaları planla.',
  group: 'Kupalar',
},
...
// SWORDS (14)
{
  ...
  reversed:
    'Ters Kılıç Ası, çarpıtma ve yarım doğrular kalıcılığı baltalar.',
  keywords: ['netlik', 'dürüstlük', 'karar', 'çarpıtma', 'hakikat'],
  context:
    'Sürmesi için: net kararlar + kanıt temelli konuşma.',
  group: 'Kılıçlar',
},
{
  ...
  reversed:
    'Ters İki Kılıç, kronik erteleme kopuş ihtimalini artırır.',
  keywords: ['kararsızlık', 'askı', 'yüzleşme', 'seçim', 'netlik'],
  context:
    'Sürmesi için: küçük net seçim + tarih.',
  group: 'Kılıçlar',
},
{
  ...
  context:
    'Sürmesi için: onarım dili + kapanış ritüeli.',
  group: 'Kılıçlar',
},
{
  ...
  reversed:
    'Ters Dört Kılıç, aşırı susuş ve kaçınma bağları gevşetir.',
  keywords: ['mola', 'iyileşme', 'sükûnet', 'kaçınma', 'ritim'],
  context:
    'Sürmesi için: planlı mola + geri dönüş tarihi.',
  group: 'Kılıçlar',
},
{
  ...
  reversed:
    'Ters Beş Kılıç, alay/küçümseme sürerse uzun vadede kopuş gelir.',
  keywords: ['ego', 'uzlaşı', 'saygı', 'alay', 'zafer'],
  context:
    'Sürmesi için: kazanmak değil anlaşmak hedefi.',
  group: 'Kılıçlar',
},
{
  ...
  reversed:
    'Ters Altı Kılıç, eski kıyıya dönmek sürekliliği zedeler.',
  keywords: ['geçiş', 'plan', 'onarım', 'istikrar', 'takip'],
  context:
    'Sürmesi için: yazılı geçiş adımları + kontrol.',
  group: 'Kılıçlar',
},
{
  ...
  reversed:
    'Ters Yedi Kılıç, gizli ajanda sürerse bağ çözülür.',
  keywords: ['şeffaflık', 'giz', 'güven', 'itiraf', 'etik'],
  context:
    'Sürmesi için: açık defter kuralı.',
  group: 'Kılıçlar',
},
{
  ...
  reversed:
    'Ters Sekiz Kılıç, kurbanlıkta ısrar ilişkiyi kilitler.',
  keywords: ['çaresizlik', 'yardım', 'inanç', 'kilit', 'özgürleşme'],
  context:
    'Sürmesi için: destek isteme + sorumluluk paylaşımı.',
  group: 'Kılıçlar',
},
{
  ...
  context:
    'Sürmesi için: gündüz konuşma + gece dinlenme kuralı.',
  group: 'Kılıçlar',
},
{
  ...
  context:
    'Sürmesi için: acı ama net kapanış + temiz sayfa.',
  group: 'Kılıçlar',
},
{
  ...
  position: 9,
  upright:
    'Kılıç Prensi, merak ve dürüst soru kültürü ilişkiyi ileri taşır.',
  reversed:
    'Ters Kılıç Prensi, dedikodu ve gözetleme kalıcılığı baltalar.',
  keywords: ['merak', 'soru', 'öğrenme', 'dedikodu', 'sınır'],
  context:
    'Sürmesi için: nazik merak + kanıt odak.',
  group: 'Kılıçlar',
},
{
...
},
{
  ...
  reversed:
    'Ters Kılıç Kraliçesi, sertlik ve yargı bağı soğutur.',
  keywords: ['netlik', 'sınır', 'nesnellik', 'sertlik', 'şefkat'],
  context:
    'Sürmesi için: net + şefkatli dil.',
  group: 'Kılıçlar',
},
{
  ...
  position: 9,
  upright:
    'Kılıç Kralı, ilke ve adil çerçeveyle ilişki uzun vadeye taşınır.',
  reversed:
    'Ters Kılıç Kralı, dogma ve katı kural sürekliliği bozar.',
  keywords: ['ilke', 'adalet', 'çerçeve', 'dogma', 'esneklik'],
  context:
    'Sürmesi için: prensip + esneklik dengesi.',
  group: 'Kılıçlar',
},
...
// WANDS (14)
{
  ...
  reversed:
    'Ters Değnek Ası, heves çabuk sönüyorsa süreklilik zayıflar.',
  keywords: ['kıvılcım', 'arzu', 'canlanma', 'süreklilik', 'heves'],
  context:
    'Sürmesi için: kıvılcımı rutine bağlayın (randevu/ritüel).',
  group: 'Asalar',
},
{
  ...
  reversed:
    'Ters İki Değnek, plan–icra boşluğu sürekliliği bozar.',
  keywords: ['vizyon', 'plan', 'ufuk', 'icra', 'karar'],
  context:
    'Sürmesi için: vizyonu takvim ve göreve çevirin.',
  group: 'Asalar',
},
{
  ...
  context:
    'Sürmesi için: beklenti eşleştirme + ara hedefler.',
  group: 'Asalar',
},
{
  ...
  reversed:
    'Ters Dört Değnek, vitrin/tören baskısı temeli zayıflatır.',
  keywords: ['eşik', 'kutlama', 'temel', 'ev', 'istikrar'],
  context:
    'Sürmesi için: önce temel, sonra tören.',
  group: 'Asalar',
},
{
  ...
  reversed:
    'Ters Beş Değnek, kaotik kavga kalıcılığı aşındırır.',
  keywords: ['tartışma', 'kural', 'rekabet', 'fasilitasyon', 'saygı'],
  context:
    'Sürmesi için: tartışma protokolü (süre/ton/ara).',
  group: 'Asalar',
},
{
  ...
  context:
    'Sürmesi için: haftalık takdir ritüeli.',
  group: 'Asalar',
},
{
  ...
  position: 9,
  upright:
    'Yedi Değnek, birlikte sınır savunusu ilişkiyi korur ve sürdürür.',
  reversed:
    'Ters Yedi Değnek, bitmeyen savunma ve inat kalıcılığı zorlar.',
  keywords: ['sınır', 'savunma', 'birlik', 'inat', 'esneklik'],
  context:
    'Sürmesi için: esnek sınır + ortak cephe.',
  group: 'Asalar',
},
{
  ...
  position: 9,
  upright:
    'Sekiz Değnek, hızlı, açık iletişim ve akışla ilişki canlı kalır.',
  reversed:
    'Ters Sekiz Değnek, iletişim kaosu ve gecikme bağa zarar verir.',
  keywords: ['hız', 'akış', 'iletişim', 'gecikme', 'netlik'],
  context:
    'Sürmesi için: tek kanal + cevap ritmi.',
  group: 'Asalar',
},
{
  ...
  context:
    'Sürmesi için: dinlenme planı + güven inşası.',
  group: 'Asalar',
},
{
  ...
  reversed:
    'Ters On Değnek, yükler pay edilmezse kopuş riski büyür.',
  keywords: ['yük', 'delege', 'sorumluluk', 'sadelik', 'denge'],
  context:
    'Sürmesi için: iş/duygu yük haritası.',
  group: 'Asalar',
},
{
  ...
  context:
    'Sürmesi için: mini projeler + bitiriş kutlaması.',
  group: 'Asalar',
},
{
...
},
{
  ...
  context:
    'Sürmesi için: ortak sahne + kıyası kapatma.',
  group: 'Asalar',
},
{
  ...
  reversed:
    'Ters Değnek Kralı, ego ve tek merkez karar kalıcılığı bozar.',
  keywords: ['vizyon', 'liderlik', 'risk', 'ego', 'katılım'],
  context:
    'Sürmesi için: yetki paylaşımı + birlikte karar.',
  group: 'Asalar',
},
...
// PENTACLES (14)
{
  ...
  context:
    'Sürmesi için: küçük ortak yatırım/plan.',
  group: 'Tılsımlar',
},
{
  ...
  position: 9,
  upright:
    'İki Tılsım, hayat dengelenirse ilişki yürür. Esnek plan şarttır.',
  reversed:
    'Ters İki Tılsım, kaos ve son dakika krizleri bağı yıpratır.',
  keywords: ['denge', 'esneklik', 'zaman', 'öncelik', 'akış'],
  context:
    'Sürmesi için: ajanda eşleştirme + kapasite sınırı.',
  group: 'Tılsımlar',
},
{
...
},
{
  ...
  position: 9,
  upright:
    'Dört Tılsım, güvenlik ve makul tasarruf ilişkiye istikrar verir.',
  reversed:
    'Ters Dört Tılsım, cimrilik/kontrol kalıcılığı zedeler.',
  keywords: ['güvenlik', 'tasarruf', 'kontrol', 'paylaşım', 'esneklik'],
  context:
    'Sürmesi için: bütçe şeffaflığı + alan bırakma.',
  group: 'Tılsımlar',
},
{
  ...
  context:
    'Sürmesi için: “biz” dili + yardım ağı.',
  group: 'Tılsımlar',
},
{
  ...
  reversed:
    'Ters Altı Tılsım, koşullu yardım ve borçlandırma bağı zedeler.',
  keywords: ['paylaşım', 'adalet', 'karşılıklılık', 'koşul', 'güç'],
  context:
    'Sürmesi için: şeffaf katkı modeli.',
  group: 'Tılsımlar',
},
{
  ...
  context:
    'Sürmesi için: periyodik değerlendirme + küçük ayar.',
  group: 'Tılsımlar',
},
{
  ...
  context:
    'Sürmesi için: ilişki standartları + pratik.',
  group: 'Tılsımlar',
},
{
  ...
  context:
    'Sürmesi için: bireysel alan + ortak keyif dengesi.',
  group: 'Tılsımlar',
},
{
  ...
  context:
    'Sürmesi için: sistem ve sınırların netleştirilmesi.',
  group: 'Tılsımlar',
},
{
  ...
  reversed:
    'Ters Tılsım Prensi, oyalanma ve erteleme kalıcılığı zayıflatır.',
  keywords: ['öğrenme', 'küçük adım', 'odak', 'disiplin', 'fırsat'],
  context:
    'Sürmesi için: mini hedef + teslim tarihi.',
  group: 'Tılsımlar',
},
{
  ...
  keywords: ['istikrar', 'güvenilirlik', 'rutin', 'durağanlık', 'iyileştirme'],
  context:
    'Sürmesi için: rutin + mikro yenilik.',
  group: 'Tılsımlar',
},
{
  ...
  context:
    'Sürmesi için: iş bölümü + takdir görünürlüğü.',
  group: 'Tılsımlar',
},
{
  ...
  reversed:
    'Ters Tılsım Kralı, para/otorite sopası kalıcılığı bozar.',
  keywords: ['güvence', 'liderlik', 'uzun vade', 'otorite', 'şeffaflık'],
  context:
    'Sürmesi için: şeffaf liderlik + ortak imza kültürü.',
  group: 'Tılsımlar',
},
];
...
export const getAllposition9Meanings = (): RelationshipProblemsPositionMeaning[] => {
