...
},
{
  ...
  keywords: ['bekleme', 'perspektif', 'erteleme', 'fedakârlık', 'belirsizlik'],
  context:
...
},
{
  ...
  context:
    'Direnç güçlü. Tetik sürekli açık kalmış. Şimdi mola kuralı şart.',
  group: 'Asalar',
},
{
...
export const getAllposition5Meanings = (): RelationshipProblemsPositionMeaning[] => {
