...
export const position8Meanings: MarriagePositionMeaning[] = [
 // ========== MAJÖR ARKANA (22) ==========
 {
  ...
  context: 'Doğal açıklık uyumu sağlar; dikkatsizlik yanlış anlaşılmalara yol açabilir.',
  group: 'Majör Arkana',
},
{
  ...
  context: 'Açık niyetler anlaşmayı kolaylaştırır; oyunlar iletişimi zedeler.',
  group: 'Majör Arkana',
},
{
