...
export const position1Meanings: MarriagePositionMeaning[] = [
  ...
  },
  {
    ...
    context:
      'Sonuç; niyet ve eylem uyumuna bağlı. Şeffaf iletişim şart.',
    group: 'Majör Arkana',
  },
  {
  ...
  },
  {
    ...
    context:
      'Sonuç; bereketli ve şefkatli bir bağ. Ama denge korunmalı.',
    group: 'Majör Arkana',
  },
  {
  ...
  },
  {
    ...
    context:
      'Sonuç; şefkatle güçlenen bir evlilik. Ama öfke dengelenmeli.',
    group: 'Majör Arkana',
  },
  {
  ...
  },
  {
    ...
    context:
      'Sonuç; tutkulu ve yoğun bir bağ. Ama özgürlük alanı korunmalı.',
    group: 'Majör Arkana',
  },
  {
  ...
  },
  {
    ...
    context:
      'Sonuç; umutla beslenen bir evlilik. Ama güven kaybı riski var.',
    group: 'Majör Arkana',
  },
  {
    id: 'the_moon_ma_pos1',
  ...
  },
  {
    ...
    context:
      'Sonuç; neşeli ve sıcak bir bağ. Ama yüzeysellikten uzak durmalı.',
    group: 'Majör Arkana',
  },
  {
  ...
  },
  {
    ...
    //-- Kupalar --//
      ...
      },
      {
        ...
        context:
          'Sonuç; şefkatli ve duygusal bir bağ. Ama sınırlar korunmalı.',
        group: 'Kupalar',
      },
      {
    ...
    //-- Kılıçlar --//
      ...
      },
      {
        ...
        context:
          'Sonuç; zorlayıcı ama dönüştürücü deneyimlerle netleşen bir bağ.',
        group: 'Kılıçlar',
      },
      {
      ...
      },
      {
        ...
        reversed:
          'Açık olunmayan şeyler gün yüzüne çıkabilir. Şeffaflık şart.',
      ...
      },
      {
        ...
        reversed:
          'Kaygıların azalmasıyla huzur geri dönecek. İyileşme başlayacak.',
      ...
      },
      {
        ...
        context:
          'Sonuç; zor bir döngünün kapanışıyla doğan yeni sayfa.',
        group: 'Kılıçlar',
      },
      {
        ...
        position: 1,
        upright:
          'Sonuç; merak, iletişim ve öğrenme isteği evliliği taze tutacak.',
        reversed:
      ...
      },
      {
        ...
        reversed:
          'Acelecilik veya öfke, evliliğin sonucunu gölgeleyebilir.',
    ...
    //-- Asalar --//
      ...
      },
      {
        ...
        position: 1,
        upright:
          'Sonuç; evlilikte kutlama, istikrar ve güvenli bir yuva olacak.',
        reversed:
      ...
      },
      {
        ...
        context:
          'Sonuç; tartışmalarla güçlenen bir evlilik. Çözüm odaklı kalmalı.',
        group: 'Asalar',
      },
      {
      ...
      },
      {
        ...
        reversed:
          'Yorgunluk ve savunmasızlık, evliliğin sonucunu zorlaştırabilir.',
      ...
      },
      {
        ...
        position: 1,
        upright:
          'Sonuç; hızlı ilerleme ve akıcı iletişimle evliliğiniz gelişecek.',
        reversed:
          'Gecikmeler veya iletişim sorunları süreci zorlayabilir.',
        keywords: ['hız', 'iletişim', 'akış', 'ilerleme'],
        context:
          'Sonuç; hızlı ve akıcı bir evlilik. Ama gecikmeler önlenmeli.',
        group: 'Asalar',
      },
      {
      ...
      },
      {
        ...
        context:
          'Sonuç; emekle şekillenen bir evlilik. Ama yükler paylaşılmalı.',
        group: 'Asalar',
      },
      {
        ...
        position: 1,
        upright:
          'Sonuç; merak, keşif ve macera ruhu evliliğinizi renklendirecek.',
        reversed:
      ...
      },
      {
        ...
        reversed:
          'Acelecilik veya sabırsızlık evliliğin sonucunu gölgeleyebilir.',
        keywords: ['cesaret', 'tutku', 'hız', 'hareket'],
        context:
          'Sonuç; tutkulu ve cesur bir evlilik. Ama sabır da gerekli.',
        group: 'Asalar',
      },
      {
        ...
        position: 1,
        upright:
          'Sonuç; özgüven, karizma ve sıcaklık evliliğinizi besleyecek.',
        reversed:
          'Kıskançlık ya da güvensizlik, evliliğin sonucunu zorlayabilir.',
      ...
      },
      {
        ...
        context:
          'Sonuç; güçlü vizyonla yönlenen bir evlilik. Ama ego yönetilmeli.',
        group: 'Asalar',
      },
    //-- Tılsımlar --//
      {
      ...
      },
      {
        ...
        position: 1,
        upright:
          'Sonuç; evliliğinizde denge, uyum ve esneklikle ilerleyiş olacak.',
        reversed:
          'Dengesizlik ve karar verememek, evliliğin sonucunu zorlaştırabilir.',
        keywords: ['denge', 'esneklik', 'uyum', 'karar'],
        context:
          'Sonuç; esnek ve dengeli bir evlilik. Ama kararlar net olmalı.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Sonuç; ortak çabalarla büyüyen bir evlilik. Ama işbirliği şart.',
        group: 'Tılsımlar',
      },
      {
      ...
      },
      {
        ...
        reversed:
          'İlgisizlik ya da özensizlik, evliliğin sonucunu zayıflatabilir.',
      ...
      },
      {
        ...
        reversed:
          'Bağımlılık ya da savurganlık, evliliğin sonucunu zorlayabilir.',
      ...
      },
      {
        ...
        reversed:
          'İsteksizlik ya da erteleme, evliliğin sonucunu yavaşlatabilir.',
      ...
      },
      {
        ...
        reversed:
          'Durağanlık ya da inatçılık, evliliğin sonucunu zorlaştırabilir.',
      ...
      },
      {
        ...
        context:
          'Sonuç; şefkatle büyüyen bir evlilik. Ama öz bakım unutulmamalı.',
        group: 'Tılsımlar',
      },
      {
