...
export const position3Meanings: MarriagePositionMeaning[] = [
  // MAJÖR ARKANA
    ...
    },
    {
      ...
      context:
        'Paylaşımda sabır ve şefkat güçlüdür. Baskıcılık sorun çıkarır.',
      group: 'Majör Arkana',
    },
    {
    ...
    },
    {
      ...
      context:
        'Paylaşımda dönüşüm zamanı. Direnç uyumu zorlaştırır.',
      group: 'Majör Arkana',
    },
    {
      ...
      context:
        'Paylaşımda uyum ve ölçü güçlüdür. Aşırılık sorun çıkarır.',
      group: 'Majör Arkana',
    },
    {
    ...
    },
    {
      ...
      context:
        'Paylaşımda krizler olabilir. Sağlam temel şarttır.',
      group: 'Majör Arkana',
    },
    {
      id: 'the_star_ma_pos3',
      ...
      context:
        'Paylaşımda umut ve iyileşme var. Güven kaybı risk oluşturur.',
      group: 'Majör Arkana',
    },
    {
      id: 'the_moon_ma_pos3',
      ...
      context:
        'Paylaşımda belirsizlik var. Netlik sağlanınca güven artar.',
      group: 'Majör Arkana',
    },
    {
      id: 'the_sun_ma_pos3',
    ...
    },
    {
      ...
      },
      {
        ...
        context:
          'Sıcak paylaşım var; ama bugünün gerçeklerine uyum şart.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Listeleri sadeleştirin. Net kriter, adil payı belirler.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Anlamsızı bırakıp değere dönmek paylaşımı rahatlatır.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Mutluluk kalemleri olabilir; adalet hissi korunmalı.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Birlik vizyonu güçlü; ancak sahicilik kaybolmamalı.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Nazik iletişimle yeni bir bütçe tarzı filizlenir.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Nazik yaklaşım güzel; süreklilik ve plan şart.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Şefkatli ama sınırları net bir bütçe ihtiyacı var.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Sakin liderlik adil paylaşımı mümkün kılar.',
        group: 'Kupalar',
      },
      ...
      // =========================
      {
        ...
        context:
          'Keskin bir plan ve tanım, adaleti sağlar.',
        group: 'Kılıçlar',
      },
      {
        ...
        context:
          'Kararı netleştirmek adil paylaşımı açar.',
        group: 'Kılıçlar',
      },
      {
        ...
        context:
          'Önce yara sarılmalı; sonra plan konuşulmalı.',
        group: 'Kılıçlar',
      },
      {
      ...
      },
      {
        ...
        reversed:
          'Yüz kurtaran çözüm ve özür, finansal barışı mümkün kılar.',
        keywords: ['ego', 'çatışma', 'maliyet', 'uzlaşı'],
        context:
          'Onur kırıcı dil değil, çözüm odak kazandırır.',
        group: 'Kılıçlar',
      },
      {
        ...
        context:
          'Aşamalı değişim, paylaşımı korur.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Yarım gerçekler güveni aşındırır; itiraf ve hizalama şarttır.',
        keywords: ['strateji', 'giz', 'dürüstlük', 'güven'],
        context:
          'Etik çizgiyi netleştirin; sonra plan yapın.',
        group: 'Kılıçlar',
      },
      {
        ...
        context:
          'Zihindeki prangayı çözmek paylaşıma alan açar.',
        group: 'Kılıçlar',
      },
      {
        ...
        context:
          'Kaygı hijyeni, para birliğini güçlendirir.',
        group: 'Kılıçlar',
      },
      {
        ...
        context:
          'Eskiyi onurlandırıp yeni plan yazma zamanı.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Dedikodu ve acele yargı, para konuşmalarını zehirler.',
        keywords: ['merak', 'veri', 'doğrulama', 'öğrenme'],
        context:
          'Kanıtlı bilgiyle adil paylaşım yapılır.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Aceleciliğin sert üslubu kanalları yakar; direnç doğar.',
        keywords: ['hız', 'kararlılık', 'strateji', 'iletişim'],
        context:
          'Sert değil, net hız kazandırır.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Aşırı eleştiri ve sarkazm bağı kırar; şefkat dengesi gerekir.',
        keywords: ['nesnellik', 'sınır', 'adalet', 'iletişim'],
        context:
          'Net ama nazik çerçeve güven verir.',
        group: 'Kılıçlar',
      },
      {
        ...
        context:
          'Adil çerçeve + empati = sağlam model.',
        group: 'Kılıçlar',
      },
      ...
      // =========================
      {
        ...
        context:
          'Somut planla paylaşım kök salar.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Dağınıklık ve erteleme, ödemeleri aksatır; denge bozulur.',
        keywords: ['denge', 'esneklik', 'öncelik', 'akış'],
        context:
          'Ritim kurmak adil paylaşımı korur.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Kim neyi yapıyor netleşirse bütçe akar.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Güven + esneklik dengesi aranmalı.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Birlikte çözüm cesareti bütçeyi iyileştirir.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Borçluluk hissi ve koşullu destek, eşitliği zedeler.',
        keywords: ['adalet', 'paylaşım', 'güç dengesi', 'güven'],
        context:
          'Şeffaf anlaşma, adil ekonomiyi kurar.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Ölç–öğren–iyileştir döngüsü bütçeyi güçlendirir.',
        group: 'Tılsımlar',
      },
      {
      ...
      },
      {
        ...
        reversed:
          'Savurganlık veya aşırı tutumluluk uçları gerginlik yaratır.',
        keywords: ['bağımsızlık', 'konfor', 'sınır', 'öz-değer'],
        context:
          'Zarif denge paylaşımı güzelleştirir.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Akraba–mülk sürtüşmeleri ve bulanık kurallar, uyumu bozar.',
        keywords: ['aile', 'miras', 'sistem', 'istikrar'],
        context:
          'Şeffaf kural seti huzur sağlar.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Erteleme ve dağınık odak, fırsatları kaçırır.',
        keywords: ['öğrenme', 'hedef', 'disiplin', 'başlangıç'],
        context:
          'Mini hedefler payı adil dağıtır.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Durağanlık ve esneklik eksikliği motivasyonu düşürür.',
        keywords: ['rutin', 'istikrar', 'tutarlılık', 'öz disiplin'],
        context:
          'Güvenilir hız, bütçe barışıdır.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Aşırı yüklenme ve öz bakım açığı, paylaşımı yorar; delege edin.',
        keywords: ['bakım', 'kaynak', 'pratiklik', 'denge'],
        context:
          'Şefkat + pratik çerçeve bütçeyi dengeler.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Mikro yönetim ve statü odağı, güveni ve paylaşımı kısar.',
        keywords: ['sağlamlık', 'liderlik', 'sistem', 'vizyon'],
        context:
          'Güç–sevgi dengesi, adil ekonomiyi kurar.',
        group: 'Tılsımlar',
      },
      ...
      // =========================
      {
        ...
        reversed:
          'İlham tıkanması ve erteleme, fırsatların kaçmasına yol açar.',
        keywords: ['ilham', 'başlangıç', 'enerji', 'girişim'],
        context:
          'Kıvılcımı plana bağlamak bütçeyi büyütür.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Kararsızlık ve konfor alanı, genişlemeyi geciktirir.',
        keywords: ['vizyon', 'plan', 'risk', 'ufuk'],
        context:
          'Ufuk haritası, adil payı görünür kılar.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Gecikmeler ve dar görüşlülük, bütçe moralini düşürür.',
        keywords: ['genişleme', 'zamanlama', 'işbirliği', 'ufuk'],
        context:
          'Planı dinamik güncellemek gerekir.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Önce temel, sonra tören; sıra önemlidir.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Yapılandırılmış diyalog gerilimi üretken kılar.',
        keywords: ['çatışma', 'rekabet', 'kural', 'fasilitasyon'],
        context:
          'Oyun kuralları anlaşılırsa verim artar.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Görünmeyen emek kırgınlık üretir; şeffaf takdir şart.',
        keywords: ['zafer', 'takdir', 'motivasyon', 'görünürlük'],
        context:
          'Başarı hikâyesini birlikte yazın.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Aşırı savunma yorar; delege ve destek denge sağlar.',
        keywords: ['savunma', 'sınır', 'kararlılık', 'destek'],
        context:
          'Net sınır, adaleti korur.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Gecikmeler ve kanal karmaşası, yanlış ödemelere yol açar.',
        keywords: ['hız', 'iletişim', 'senkron', 'akış'],
        context:
          'Sıralama ve rol netliği akışı korur.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Aşırı tetikte olma ve yorgunluk, tartışma eşiğini düşürür.',
        keywords: ['dayanıklılık', 'tetikte', 'mola', 'süreklilik'],
        context:
          'Ritim korundukça sonuç gelir.',
        group: 'Asalar',
      },
      {
      ...
      },
      {
        ...
        reversed:
          'Dağınık ilgi ve yarıda bırakma, finansal güveni zedeler.',
        keywords: ['keşif', 'heves', 'pilot', 'odak'],
        context:
          'Küçük dene–öğren döngüsü bütçeyi büyütür.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Savruk enerji ve yarıda bırakma, güveni ve nakit akışını bozar.',
        keywords: ['hız', 'atılganlık', 'risk', 'taahhüt'],
        context:
          'Cesaret + plan = sürdürülebilirlik.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Değerle hizalı görünürlük bereket getirir.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Ego ve otoriter ton, işbirliğini ve paylaşımı kısar.',
        keywords: ['vizyon', 'liderlik', 'cesaret', 'ölçek'],
        context:
          'Paylaşılan vizyon, adil ve büyük bütçe doğurur.',
        group: 'Asalar',
      }
];
