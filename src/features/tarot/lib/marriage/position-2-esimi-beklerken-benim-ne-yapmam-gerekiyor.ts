...
export const position2Meanings: MarriagePositionMeaning[] = [
  // MAJÖR ARKANA
    ...
    },
    {
      ...
      reversed:
        'Aşırı izolasyon süreci zorlaştırır. Dengeyi bulmak önemlidir.',
    ...
    },
    {
      ...
      reversed:
        'Değişime direnç göstermek sizi zorlayabilir. Akışa güvenin.',
    ...
    },
    {
      ...
      reversed:
        'Aşırı bekleyiş ya da tıkanıklık süreci zorlaştırır. Esnek olun.',
    ...
    },
    {
      ...
      reversed:
        'Geçmişe takılı kalmak süreci zorlaştırır. Değişime izin verin.',
      keywords: ['dönüşüm', 'bitiş', 'yenilenme', 'bırakma'],
      context:
        'Beklerken geçmişi bırakmak faydalı. Bu sizi yeniye hazırlar.',
      group: 'Majör Arkana',
    },
    {
      ...
      context:
        'Beklerken uyumlu ve ölçülü olmak faydalı. Bu sizi huzurlu kılar.',
      group: 'Majör Arkana',
    },
    {
      ...
      context:
        'Beklerken özgürleşmek önemlidir. Bu sizi sağlıklı bağa hazırlar.',
      group: 'Majör Arkana',
    },
    {
      ...
      reversed:
        'Gerçeklerle yüzleşmemek süreci zorlaştırır. Yıkımı ertelemeyin.',
    ...
    },
    {
      ...
      reversed:
        'Umutsuzluk süreci zorlaştırır. İnancınızı canlı tutun.',
      keywords: ['umut', 'şifa', 'inanç', 'yenilenme'],
      context:
        'Beklerken umutlu olmak faydalı. Şifa süreci sizi güçlendirir.',
      group: 'Majör Arkana',
    },
    {
      id: 'the_moon_ma_pos2',
      ...
      context:
        'Beklerken sezgilere güvenmek faydalı. Belirsizlik geçicidir.',
      group: 'Majör Arkana',
    },
    {
      id: 'the_sun_ma_pos2',
    ...
    },
    {
      ...
      context:
        'Beklerken geçmişten öğrenmek faydalı. Affediş sizi hafifletir.',
      group: 'Majör Arkana',
    },
    {
      ...
      reversed:
        'Eksik kalanlar süreci zorlaştırır. Tamamlamaya odaklanın.',
      keywords: ['tamamlanma', 'bütünlük', 'döngü', 'başarı'],
      context:
        'Beklerken döngüleri kapatmak faydalı. Bu sizi yeniye hazırlar.',
      group: 'Majör Arkana',
    },
      // KUPALAR (14)
      {
        ...
        context:
          'Beklerken kalbinizi açmak ve duyguları ifade etmek faydalı olur.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Beklerken sağlıklı bağ kurma becerisi önemlidir.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Beklerken dostluklarınızı beslemek sizi hazırlar.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Beklerken şükür bilinci ve yeniliklere açıklık faydalı olur.',
        group: 'Kupalar',
      },
      {
      ...
      },
      {
        ...
        context:
          'Beklerken iç çocuğu onurlandırmak kalbi yumuşatır.',
        group: 'Kupalar',
      },
      {
        ...
        reversed:
          'Hayal ile gerçek arasındaki dengeyi bulun. Dağılmaktan kaçının.',
        keywords: ['hayal', 'seçim', 'vizyon', 'gerçeklik'],
        context:
          'Beklerken vizyonunuzu netleştirmek faydalı olur.',
        group: 'Kupalar',
      },
      {
        ...
        reversed:
          'Gitmek-kalmak ikilemini çözün. Cesur kararlar ilerletir.',
        keywords: ['ayrılış', 'anlam', 'cesaret', 'yeni yol'],
        context:
          'Beklerken anlamlı olana yönelmek faydalı olur.',
        group: 'Kupalar',
      },
      {
        ...
        reversed:
          'Yüzeysel tatminler yerine kalıcı mutluluğa odaklanın.',
        keywords: ['mutluluk', 'tatmin', 'şükür', 'bolluk'],
        context:
          'Beklerken kendi mutluluğunuzu yaratmak faydalı olur.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Beklerken birlik duygusunu geliştirmek faydalı olur.',
        group: 'Kupalar',
      },
      {
        ...
        reversed:
          'Aşırı hassasiyet süreci zorlaştırır. Gerçeklikle dengede olun.',
        keywords: ['yaratıcılık', 'sezgi', 'oyun', 'ifade'],
        context:
          'Beklerken yaratıcılık ve merak kalbi açar.',
        group: 'Kupalar',
      },
      {
        ...
        reversed:
          'Tutarsızlık ya da aşırı idealizm süreci zorlaştırır. Net olun.',
        keywords: ['hareket', 'hayal', 'cesaret', 'duygu'],
        context:
          'Beklerken duygusal cesaret faydalı olur.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Beklerken empati ve şefkat faydalı olur.',
        group: 'Kupalar',
      },
      {
        ...
        context:
          'Beklerken duygusal olgunluk faydalı olur.',
        group: 'Kupalar',
      },
      ...
      // KILIÇLAR (14)
      {
        ...
        context:
          'Beklerken net düşünmek faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Kaçınılan karar süreci tıkar. Yüzleşmek gerekir.',
        keywords: ['karar', 'ikilem', 'denge', 'seçim'],
        context:
          'Beklerken kararlılık önemlidir.',
        group: 'Kılıçlar',
      },
      {
        ...
        position: 2,
        upright:
          'Geçmiş kırgınlıklarla yüzleşin. Beklerken kalbinizi iyileştirin.',
        reversed:
          'Acının içinde kalmak süreci zorlaştırır. Affediş yol açar.',
        keywords: ['kırgınlık', 'yas', 'affediş', 'şifa'],
        context:
          'Beklerken kalp yaralarını iyileştirmek faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        position: 2,
        upright:
          'Dinlenin, zihninizi toparlayın. Beklerken içsel sakinlik bulun.',
        reversed:
          'Dinlenmeyi reddetmek tükenmeye yol açar. Molalara izin verin.',
        keywords: ['dinlenme', 'toparlanma', 'sükunet', 'iyileşme'],
        context:
          'Beklerken dinlenmek faydalı olur.',
        group: 'Kılıçlar',
      },
      {
      ...
      },
      {
        ...
        position: 2,
        upright:
          'Geçmişi geride bırakın. Beklerken sakin sulara yönelin.',
        reversed:
          'Geçmiş bağlar sizi geri çekebilir. Onları çözün.',
        keywords: ['geçiş', 'sakinlik', 'ilerleme', 'bırakma'],
        context:
          'Beklerken geçmişi bırakmak faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Kendi kendini kandırmak süreci zorlaştırır. Açık olun.',
        keywords: ['strateji', 'dürüstlük', 'plan', 'netlik'],
        context:
          'Beklerken dürüst strateji faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Kendi korkularınızı aşmak gerekir. Cesaret faydalıdır.',
        keywords: ['engeller', 'özgürlük', 'korku', 'cesaret'],
        context:
          'Beklerken korkuları aşmak faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Felaketleştirme süreci zorlaştırır. Gerçeklere odaklanın.',
        keywords: ['kaygı', 'korku', 'zihin', 'gerçeklik'],
        context:
          'Beklerken kaygıyı aşmak faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        position: 2,
        upright:
          'Bir döngüyü kapatın. Beklerken yeni başlangıçlara hazırlanın.',
        reversed:
          'Geçmişin yükünü bırakın. Yenilenme yakındır.',
        keywords: ['bitiş', 'yenilenme', 'kapanış', 'başlangıç'],
        context:
          'Beklerken bitişleri kabullenmek faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        context:
          'Beklerken öğrenmek faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        position: 2,
        upright:
          'Hedeflerinize hızla ilerleyin. Beklerken kararlılıkla adım atın.',
        reversed:
          'Acelecilik ya da öfke süreci zorlaştırır. Dengeli hız bulun.',
        keywords: ['hedef', 'hız', 'karar', 'azim'],
        context:
          'Beklerken kararlılık faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        position: 2,
        upright:
          'Mantık ve objektiflik kazanın. Beklerken netlik önemlidir.',
        reversed:
          'Aşırı eleştirellik süreci zorlaştırır. Şefkatle dengeleyin.',
        keywords: ['netlik', 'mantık', 'objektiflik', 'adalet'],
        context:
          'Beklerken mantıklı olmak faydalı olur.',
        group: 'Kılıçlar',
      },
      {
        ...
        reversed:
          'Katı dogmalar süreci zorlaştırır. Esnek olun.',
        keywords: ['bilgi', 'strateji', 'ilke', 'otorite'],
        context:
          'Beklerken bilgeliği artırmak faydalı olur.',
        group: 'Kılıçlar',
      },
      ...
      // ASALAR (14)
      {
        ...
        context:
          'Beklerken yaratıcı enerjiyi kullanmak faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        reversed:
          'Kararsızlık ya da korku süreci zorlaştırır. Cesaret gösterin.',
        keywords: ['planlama', 'vizyon', 'cesaret', 'gelecek'],
        context:
          'Beklerken gelecek planları yapmak faydalı olur.',
        group: 'Asalar',
      },
      {
      ...
      },
      {
        ...
        context:
          'Beklerken sosyal bağları güçlendirmek faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken sağlıklı rekabet öğrenmek faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken başarıları onurlandırmak faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken pozisyonunuzu savunmak faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken hızlı ve kararlı olmak faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken dayanıklılık göstermek faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken sorumlulukları organize etmek faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken yeni şeyler öğrenmek faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken cesur olmak faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken özgüven artırmak faydalı olur.',
        group: 'Asalar',
      },
      {
        ...
        context:
          'Beklerken vizyoner liderlik göstermek faydalı olur.',
        group: 'Asalar',
      },
      ...
      // TILSIMLAR (14)
      {
        ...
        position: 2,
        upright:
          'Maddi fırsatları değerlendirin. Beklerken sağlam temel kurun.',
        reversed:
          'Kaçırılan fırsatlar süreci yavaşlatır. Odaklı olun.',
        keywords: ['fırsat', 'temel', 'maddi güven', 'başlangıç'],
        context:
          'Beklerken temel oluşturmak faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        position: 2,
        upright:
          'Zaman ve enerji yönetimini öğrenin. Beklerken esnek kalın.',
        reversed:
          'Aşırı dağınıklık süreci zorlaştırır. Öncelik belirleyin.',
        keywords: ['denge', 'zaman', 'esneklik', 'öncelik'],
        context:
          'Beklerken dengeli olmak faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Beklerken işbirliği ve ilişkileri geliştirmek faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Beklerken maddi dengeyi kurmak faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Yardım reddetmek süreci zorlaştırır. Destek kabul edin.',
        keywords: ['dayanıklılık', 'zorluk', 'yardım', 'destek'],
        context:
          'Beklerken dayanıklılık ve yardım alma faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Dengesiz paylaşım süreci zorlaştırır. Adil olun.',
        keywords: ['cömertlik', 'paylaşım', 'denge', 'adalet'],
        context:
          'Beklerken cömertlik ve adil paylaşım faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Beklerken sabır ve uzun vadeli düşünmek faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Beklerken yetenek geliştirmek faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Beklerken bağımsızlık ve öz değer faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Beklerken aile bağlarını güçlendirmek faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Erteleme ya da dağınıklık süreci zorlaştırır. Odaklanın.',
        keywords: ['fırsat', 'pratiklik', 'öğrenme', 'başlangıç'],
        context:
          'Beklerken yeni fırsatları değerlendirmek faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'İnertlik ya da aşırı yavaşlık süreci zorlaştırır. Hareket edin.',
        keywords: ['kararlılık', 'güvenilirlik', 'sabır', 'sorumluluk'],
        context:
          'Beklerken kararlılık ve güvenilirlik faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        reversed:
          'Aşırı kaygı ya da materyalizm süreci zorlaştırır. Dengeli olun.',
        keywords: ['şefkat', 'pratiklik', 'besleyicilik', 'zenginlik'],
        context:
          'Beklerken pratik şefkat göstermek faydalı olur.',
        group: 'Tılsımlar',
      },
      {
        ...
        context:
          'Beklerken maddi istikrar kurmak faydalı olur.',
        group: 'Tılsımlar',
      },
];
