    ...
    "service": [
      {
        "@type": "Service",
        "name": "Tarot Okuması",
        "description": "Profesyonel tarot kartları ile aşk, kariyer ve yaşam rehberliği",
        "provider": {
          "@type": "Organization",
          "name": "Büşbüşkimki"
        },
  ...
  return (
    <>
      ...
      <div className='relative overflow-hidden'>
        ...
        <div className='absolute top-20 left-10 text-4xl opacity-20 animate-float' aria-hidden='true'>✨</div>
        <div className='absolute top-40 right-20 text-3xl opacity-30 animate-ethereal-drift' aria-hidden='true'>🔮</div>
        <div className='absolute bottom-40 left-20 text-2xl opacity-25 animate-crystal-rotate' aria-hidden='true'>💎</div>
        <div className='absolute top-60 right-10 text-3xl opacity-20 animate-moon-phase' aria-hidden='true'>🌙</div>
        ...
        <div className='relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center'>
          ...
          <header className='mb-12 animate-mystical-entrance'>
            ...
            <h2 className='text-xl md:text-2xl lg:text-3xl text-cosmic-300 font-body mb-4'>
              {translate('home.hero.subtitle', 'Geleceğinizi Keşfedin, Kaderinizi Anlayın')}
            </h2>
            <p className='text-lg md:text-xl text-cosmic-400 max-w-4xl mx-auto leading-relaxed'>
              {translate('home.hero.description', 'Kartların ve sayıların gizemli dünyasında yolculuğa çıkın. Profesyonel tarot okumaları ve numeroloji analizleri ile hayatınızın sırlarını keşfedin.')}
            </p>
          </header>

          {/* Services Showcase */}
          <section className='grid md:grid-cols-2 gap-8 max-w-6xl w-full mb-16 animate-fadeIn' aria-label='Hizmetlerimiz'>
            {/* Tarot Service Card */}
            <Link
            ...
            >
              ...
              <div className='relative z-10'>
                <div className='text-6xl mb-6 group-hover:animate-float' aria-hidden='true'>
                  🔮
                </div>
                ...
                <p className='text-cosmic-200 leading-relaxed mb-6'>
                  {translate('home.services.tarot.description', 'Kartların gizemli dünyasında yolculuğa çıkın. Geçmiş, şimdi ve geleceğinizi keşfedin.')}
                </p>
                <div className='flex flex-wrap gap-2 mb-6'>
                  {['Aşk Açılımı', 'Kariyer Rehberliği', 'Günlük Rehberlik', 'Detaylı Yorumlama'].map((feature, index) => (
                    <span
                      key={index}
            ...
            >
              ...
              <div className='relative z-10'>
                ...
                <h2 className='text-3xl font-mystical font-semibold text-golden-300 mb-4'>
                  {translate('home.services.numerology.title', 'Numeroloji Analizi')}
                </h2>
                <p className='text-cosmic-200 leading-relaxed mb-6'>
                  {translate('home.services.numerology.description', 'Sayıların sırlarını keşfedin. Yaşam yolunuzu, ifade sayınızı ve ruhsal arzunuzu öğrenin.')}
                </p>
                <div className='flex flex-wrap gap-2 mb-6'>
                  {['Yaşam Yolu', 'İfade Sayısı', 'Ruhsal Arzu', 'Günlük Sayı'].map((feature, index) => (
                    <span
                      key={index}
                      className='px-3 py-1 bg-golden-500/20 text-golden-300 text-sm rounded-full border border-golden-500/30'
                    >
                ...
                <div className='text-golden-400 font-medium group-hover:text-golden-300 transition-colors text-lg'>
                  {translate('home.services.numerology.button', 'Numeroloji Analizi')} →
                </div>
              </div>
            </Link>
          </section>
          ...
          {/* Features Section */}
          <section className='max-w-6xl w-full mb-16 animate-slideUp' aria-label='Özelliklerimiz'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
              {[
                {
                  icon: '✨',
                  title: translate('home.features.authentic.title', 'Orijinal Rehberlik'),
                  description: translate('home.features.authentic.description', 'Geleneksel tarot ve numeroloji yöntemleri')
                },
                {
                  icon: '🎯',
                  title: translate('home.features.personalized.title', 'Kişiselleştirilmiş'),
                  description: translate('home.features.personalized.description', 'Size özel detaylı analizler')
                },
                {
                  icon: '🔒',
                  title: translate('home.features.secure.title', 'Güvenli'),
                  description: translate('home.features.secure.description', 'Verileriniz tamamen güvende')
                },
                {
                  icon: '🌍',
                  title: translate('home.features.multilingual.title', 'Çok Dilli'),
                  description: translate('home.features.multilingual.description', 'Türkçe, İngilizce ve Sırpça destek')
                }
              ].map((feature, index) => (
                <div
                  key={index}
                ...
                >
                  <div className='text-4xl mb-4 group-hover:animate-float' aria-hidden='true'>{feature.icon}</div>
          ...
          {/* Stats Section */}
          <section className='max-w-4xl w-full mb-16 animate-fadeIn' aria-label='İstatistiklerimiz'>
            ...
            <div className='grid grid-cols-3 gap-8 text-center'>
              <div className='bg-gradient-to-br from-cosmic-800/30 to-mystical-800/30 backdrop-blur-mystical border border-cosmic-500/20 rounded-mystical p-6'>
                <div className='text-3xl font-bold text-golden-400 mb-2'>10K+</div>
                <div className='text-cosmic-300 text-sm'>{translate('home.stats.users', 'Aktif Kullanıcı')}</div>
              </div>
              <div className='bg-gradient-to-br from-cosmic-800/30 to-mystical-800/30 backdrop-blur-mystical border border-cosmic-500/20 rounded-mystical p-6'>
                ...
                <div className='text-cosmic-300 text-sm'>{translate('home.stats.readings', 'Tamamlanan Okuma')}</div>
              </div>
              <div className='bg-gradient-to-br from-cosmic-800/30 to-mystical-800/30 backdrop-blur-mystical border border-cosmic-500/20 rounded-mystical p-6'>
                <div className='text-3xl font-bold text-golden-400 mb-2'>94%</div>
                <div className='text-cosmic-300 text-sm'>{translate('home.stats.satisfaction', 'Memnuniyet Oranı')}</div>
              </div>
            </div>
          </section>
          {/* SEO Content */}
          <footer className='mt-16 text-center animate-slideUp'>
            <div className='text-cosmic-500 text-xs max-w-4xl mx-auto leading-relaxed'>
              <p>
                Büşbüşkimki olarak, profesyonel tarot okuması ve numeroloji analizi hizmetleri sunuyoruz. 
                Aşk rehberliği, kariyer rehberliği, günlük rehberlik ve detaylı numeroloji analizleri ile hayatınızın her alanında 
                rehberlik alabilirsiniz. Mistik rehberlik, ruhani danışmanlık ve kader analizi konularında 
