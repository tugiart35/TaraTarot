...
export async function generateMetadata({
  ...
  const seoData = {
    tr: {
      ...
      keywords:
        'tarot falı, numeroloji, astroloji, fal, giriş yap, kayıt ol, büşbüşkimki',
      canonical: 'https://busbuskimki.com/tr/auth',
      openGraph: {
        title: 'Giriş Yap | Büşbüşkimki - Tarot Falı ve Numeroloji',
        description:
          "Büşbüşkimki'ye güvenli giriş yapın. Tarot falı, numeroloji ve astroloji hizmetlerinden yararlanın.",
        type: 'website',
        locale: 'tr_TR',
    ...
    en: {
      ...
      description:
        'Sign in securely to Busbuskimki. Access tarot reading, numerology and astrology services. Register for free and discover your future.',
      keywords:
        'tarot reading, numerology, astrology, fortune telling, sign in, register, busbuskimki',
      canonical: 'https://busbuskimki.com/en/auth',
      openGraph: {
        title: 'Sign In | Busbuskimki - Tarot Reading and Numerology',
        description:
          'Sign in securely to Busbuskimki. Access tarot reading, numerology and astrology services.',
        type: 'website',
        locale: 'en_US',
    ...
    sr: {
      ...
      description:
        'Prijavite se sigurno na Busbuskimki. Pristupite tarot čitanju, numerologiji i astrologiji. Registrujte se besplatno i otkrijte svoju budućnost.',
      keywords:
        'tarot čitanje, numerologija, astrologija, gatanje, prijavite se, registrujte se, busbuskimki',
