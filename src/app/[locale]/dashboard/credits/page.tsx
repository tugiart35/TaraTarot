    ...
    return (
      <div className="min-h-screen bg-cosmic-black flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-text-celestial text-lg">🔮 Kredi geçmişi yükleniyor...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-cosmic-black text-white">
      ...
      <header className="border-b border-cosmic-fog p-4">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-text-celestial">Kredi Geçmişi</span>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 text-text-celestial">Kredi Geçmişi</h1>
        ...
        {transactions.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-text-celestial mb-2">Henüz işlem bulunmuyor</h3>
