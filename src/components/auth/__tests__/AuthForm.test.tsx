...
const mockUseRememberMe = useRememberMe as jest.MockedFunction<
  typeof useRememberMe
>;
...
describe('AuthForm', () => {
  ...
  describe('Password Reset', () => {
    it('should show password reset form when forgot password is clicked', () => {
      ...
      expect(
        screen.getByLabelText('Şifre sıfırlama e-posta adresi')
      ).toBeInTheDocument();
    });
    ...
    it('should call resetPassword when password reset form is submitted', async () => {
      ...
      const emailInput = screen.getByLabelText(
        'Şifre sıfırlama e-posta adresi'
      );
  ...
  describe('Error Handling', () => {
    ...
    it('should display callback failed error message', () => {
      ...
      expect(
        screen.getByText('Giriş işlemi başarısız oldu. Lütfen tekrar deneyin.')
      ).toBeInTheDocument();
    });
  });
