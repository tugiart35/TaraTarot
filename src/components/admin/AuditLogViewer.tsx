...
import { auditLogger, AuditLogEntry, AuditAction, ResourceType } from '@/lib/audit-logger';
...
export default function AuditLogViewer({ className = '', limit = 50 }: AuditLogViewerProps) {
        ...
        <div className="admin-glass rounded-xl p-4 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <select
              ...
              onChange={(e) => handleFilterChange({ severity: e.target.value as any || undefined })}
      ...
      <div className="space-y-3">
        {logs.length === 0 ? (
          ...
          logs.map((log) => {
            ...
            return (
              <div key={log.id} className="admin-glass rounded-xl p-4 hover:bg-slate-700/50 transition-colors">
