...
import { X, Coins, BookOpen, TrendingUp, Crown } from 'lucide-react';
          ...
          <div className='mb-8'>
              ...
              <div>
                ...
                <div className='flex items-center mt-2'>
                  ...
                  <span className='text-sm text-gold'>
                    {t('dashboard.memberSince', 'Üye olma')}:{' '}
                    {profile?.created_at
            ...
            <div className='grid grid-cols-3 gap-4 mb-6'>
              ...
              <div className='bg-lavender/10 rounded-lg p-4 text-center'>
                ...
                <p className='text-sm text-lavender/80'>
                  {t('dashboard.level', 'Seviye')}
                </p>
                <p className='text-lg font-bold text-white'>
                  {(profile?.total_readings || 0) > 50
                    ? t('dashboard.expert', 'Uzman')
                    : (profile?.total_readings || 0) > 20
                      ? t('dashboard.intermediate', 'Orta')
