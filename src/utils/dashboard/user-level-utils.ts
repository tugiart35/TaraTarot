...
import { Star, BookOpen, Heart, Target, TrendingUp, Sparkles } from 'lucide-react';
...
export const getUserLevelString = (
  ...
  if (recentReadings.length > 30) return 'Uzman';
  if (recentReadings.length > 13) return 'Orta';
  return 'Başlangıç';
};
